class Cart:
    def __init__(self, request):
        ...
        # Stores the current user's session. This means that you can store information about the user, such as their shopping cart 
        ...
        if not cart:
            ...
            # Initialize the total amount to '0', slef.session has now a key called "cartTotalToPay" with the of 0
            Total_to_pay = self.session['cartTotalToPay'] = '0'
        
        # With this line of code the cart we create the cart and we pass it as a constructor attribute
        self.cart = cart
